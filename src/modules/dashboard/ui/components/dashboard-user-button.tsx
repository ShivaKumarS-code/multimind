  ...
  return (
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end" side="right" className="w-72">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className="cursor-pointer justify-between flex items-center">
                Billing 
                <CreditCardIcon className="size-4" />
            </DropdownMenuItem>
            <DropdownMenuItem onClick={onLogout} className="cursor-pointer justify-between flex items-center">
                Logout
