            ...
            <Form {...form}>
               <form onSubmit={form.handleSubmit(submit)} className="p-6 md:p-8">
                  <div className="flex flex-col gap-6">
                         ...
                         <FormField 
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input type="text" placeholder="Shiva" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                      ...
                      <div className="after:border-border relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:text-center after:border-t">
